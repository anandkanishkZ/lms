 ...
 * Complete module/subject listing page with filters, search, and pagination
...
import { ModuleCard, ModuleCardData, ModuleGrid } from './ModuleCard';
...
export interface ModuleListTemplateProps {
...
/**
 * Module List Template - Full page component
 */
export const ModuleListTemplate: React.FC<ModuleListTemplateProps> = ({
  modules,
  totalModules = 0,
  categories = [],
  filters = {},
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {totalModules.toLocaleString()} modules available
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500 dark:text-gray-400">No modules match your filters</p>
            </div>
          ) : (
            modules.map((module) => (
              <ModuleCard
