 ...
 * Complete course detail page with overview, curriculum, reviews, and enrollment
 * Includes: Course header, tabs navigation, module accordion, reviews, related courses
 */
...
/**
 * Course Detail Template - Full course detail page
 */
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              {course.rating && (
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-blue-100">({course.totalRatings?.toLocaleString()} ratings)</span>
                </div>
              )}
            ...
            <UserAvatar
              ...
              subtitle={`${course.instructor.totalCourses || 0} courses • ${course.instructor.totalStudents?.toLocaleString() || 0} students`}
              size="md"
              showName
            />
              ...
              <div className="p-6 space-y-4">
                {course.isEnrolled ? (
                  <>
                    ...
                    <Button fullWidth size="lg" onClick={onStartCourse}>
      ...
      <Tabs
        tabs={[
          ...
          },
          {
            value: 'curriculum',
            label: 'Curriculum',
            content: course.modules && course.modules.length > 0 ? (
              <Card>
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    {course.modules.length} modules • {totalLessons} lessons • {formatDuration(totalDuration)}
                  </p>
                </div>
                <Accordion
                  items={course.modules.map((module) => ({
                    id: module.id,
                    title: `${module.title} ${module.duration ? `(${formatDuration(module.duration)})` : ''}`,
                    content: (
                      <div className="space-y-2">
          ...
          {
            value: 'reviews',
            label: `Reviews ${course.totalRatings ? `(${course.totalRatings})` : ''}`,
            content: (
              <div className="space-y-6">
                {/* Rating Summary */}
                <Card>
...
/**
 * Course Detail Skeleton (Loading state)
 */
